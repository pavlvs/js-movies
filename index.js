...
const runComparison = () => {
    const leftSideStats = Array.from(
        document.querySelectorAll('#left-summary .notification')
    )

    const rightSideStats = Array.from(
        document.querySelectorAll('#right-summary .notification')
    )
